...
<tbody><tr id="row14681151161712"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p id="p1682161114176"><a name="p1682161114176"></a><a name="p1682161114176"></a><span id="ph188203133175"><a name="ph188203133175"></a><a name="ph188203133175"></a>2019-11-30</span></p>
</td>
<td class="cellrowborder" valign="top" width="79%" headers="mcps1.1.3.1.2 "><p id="p127286222174"><a name="p127286222174"></a><a name="p127286222174"></a>第二十三次正式发布。</p>
<p id="p1072882218170"><a name="p1072882218170"></a><a name="p1072882218170"></a>修改以下内容：</p>
<a name="ul10244104481717"></a><a name="ul10244104481717"></a><ul id="ul10244104481717"><li><a href="创建用户并授权使用DWS.md">创建用户并授权使用DWS</a></li><li><a href="创建DWS自定义策略.md">创建DWS自定义策略</a></li></ul>
</td>
</tr>
...
<a name="ul18609347182315"></a><a name="ul18609347182315"></a><ul id="ul18609347182315"><li><a href="修改参数.md">修改参数</a></li></ul>
<p id="p8906204612526"><a name="p8906204612526"></a><a name="p8906204612526"></a>修改以下内容：</p>
<a name="ul99061646155215"></a><a name="ul99061646155215"></a><ul id="ul99061646155215"><li><a href="创建集群.md">创建集群</a></li><li><a href="购买包年包月套餐.md">购买包年包月套餐</a></li><li><a href="调整集群大小.md">调整集群大小</a>：在执行调整大小操作时，DWS会先为集群创建一次自动快照，快照创建成功后再调整集群大小。</li><li><a href="快照概述.md">快照概述</a></li><li><a href="设置自动快照策略.md">设置自动快照策略</a>：提升自动快照备份的频率。</li><li><a href="管理参数模板.md">管理参数模板</a>：增加参数update_lockwait_timeout。</li><li><a href="使用Data-Studio图形界面客户端连接集群.md">使用Data Studio图形界面客户端连接集群</a>：从Data Studio 18.2.0 SPC1版本开始，客户端SSL秘钥只支持PK8格式。</li></ul>
</td>
</tr>
...
<p id="p889022105710"><a name="p889022105710"></a><a name="p889022105710"></a>删除以下章节：IAM中创建DWS委托</p>
</td>
</tr>
...
<a name="ul1332149121614"></a><a name="ul1332149121614"></a><ul id="ul1332149121614"><li><a href="转储数据库审计日志.md">转储数据库审计日志</a></li><li>15.4-IAM中创建DWS委托</li></ul>
<p id="p0592113813111"><a name="p0592113813111"></a><a name="p0592113813111"></a>修改以下内容：</p>
<a name="ul10624130171620"></a><a name="ul10624130171620"></a><ul id="ul10624130171620"><li><a href="创建集群.md">创建集群</a></li><li><a href="调整集群大小.md">调整集群大小</a></li><li><a href="管理参数模板.md">管理参数模板</a></li></ul>
</td>
</tr>
...
<a name="ul11222103018399"></a><a name="ul11222103018399"></a><ul id="ul11222103018399"><li><a href="创建集群.md">创建集群</a></li><li><a href="查看集群状态信息.md">查看集群状态信息</a></li><li><a href="管理参数模板.md">管理参数模板</a></li></ul>
</td>
</tr>
...
<a name="ul513845515015"></a><a name="ul513845515015"></a><ul id="ul513845515015"><li><a href="创建集群.md">创建集群</a></li><li><a href="查看集群状态信息.md">查看集群状态信息</a></li></ul>
...
<a name="ul328312016333"></a><a name="ul328312016333"></a><ul id="ul328312016333"><li><a href="购买包年包月套餐.md">购买包年包月套餐</a></li><li><a href="下载JDBC或ODBC驱动.md">下载JDBC或ODBC驱动</a></li></ul>
</td>
</tr>
...
<a name="ul1899172011500"></a><a name="ul1899172011500"></a><ul id="ul1899172011500"><li><a href="购买包年包月套餐.md">购买包年包月套餐</a></li><li><a href="连接集群的方法.md">连接集群的方法</a></li></ul>
...
<a name="ul1588352615216"></a><a name="ul1588352615216"></a><ul id="ul1588352615216"><li><a href="创建集群.md">创建集群</a>：新增参数组。</li><li><a href="恢复快照.md">恢复快照</a>：新增参数组。</li></ul>
</td>
</tr>
...
<a name="ul1560411151488"></a><a name="ul1560411151488"></a><ul id="ul1560411151488"><li><a href="使用Python第三方库psycopg2连接集群.md">使用Python第三方库psycopg2连接集群</a></li><li><a href="查看管理控制台关键操作审计日志.md">查看管理控制台关键操作审计日志</a></li></ul>
<p id="p1746061719315"><a name="p1746061719315"></a><a name="p1746061719315"></a>修改以下内容：</p>
<a name="ul122513102812"></a><a name="ul122513102812"></a><ul id="ul122513102812"><li><a href="查看集群状态信息.md">查看集群状态信息</a>：修改集群连接地址描述。</li><li><a href="获取集群连接地址.md">获取集群连接地址</a>：修改集群连接地址描述。</li></ul>
</td>
</tr>
...
<a name="ul12727517181720"></a><a name="ul12727517181720"></a><ul id="ul12727517181720"><li><a href="标签管理.md">标签管理</a>：新增为集群添加标签以及根据标签搜索集群的功能。</li><li>7.3.5-使用gsql客户端连接集群（SSL方式） ：新增gsql以SSL方式连接集群的内容。</li><li><a href="使用Data-Studio图形界面客户端连接集群.md">使用Data Studio图形界面客户端连接集群</a>：新增使用图形化客户端Data Studio连接集群的功能。</li><li>新增添加扩展应用并使用扩展应用连接集群的功能：<a name="ul1015705015533"></a><a name="ul1015705015533"></a><ul id="ul1015705015533"><li><a href="管理扩展应用.md">管理扩展应用</a></li><li><a href="使用扩展应用pgAdmin4连接集群.md">使用扩展应用pgAdmin4连接集群</a></li><li><a href="pgAdmin4使用限制.md">pgAdmin4使用限制</a></li></ul>
</li><li><a href="开发规范.md">开发规范</a>：新增使用代码方式连接集群的相关开发规范。</li><li>新增给用户提供事件通知的功能：<a name="ul928663210111"></a><a name="ul928663210111"></a><ul id="ul928663210111"><li><a href="事件通知概述.md">事件通知概述</a></li><li><a href="订阅事件通知.md">订阅事件通知</a></li><li><a href="查看事件.md">查看事件</a></li></ul>
</li></ul>
...
<a name="ul5151347232"></a><a name="ul5151347232"></a><ul id="ul5151347232"><li><a href="创建集群.md">创建集群</a>：新增配额校验相关内容。</li><li><a href="调整集群大小.md">调整集群大小</a>：新增配额校验相关内容。</li><li><a href="恢复快照.md">恢复快照</a>：新增配额校验相关内容。</li><li><a href="使用JDBC连接数据库.md">使用JDBC连接数据库</a>：增加示例演示如何基于DWS提供的JDBC接口开发应用程序。</li><li><a href="监控集群.md">监控集群</a>：新增创建告警和配置OBS转储相关内容。</li></ul>
<p id="p1311145919133"><a name="p1311145919133"></a><a name="p1311145919133"></a>增加以下内容：</p>
<a name="ul087105238"></a><a name="ul087105238"></a><ul id="ul087105238"><li><a href="设置自动快照策略.md">设置自动快照策略</a>：新增设置自动快照策略。</li><li><a href="使用pgAdmin连接集群.md">使用pgAdmin连接集群</a>：新增使用pgAdmin连接数据库。</li></ul>
</td>
</tr>
...
<a name="ul1164907494335"></a><a name="ul1164907494335"></a><ul id="ul1164907494335"><li><a href="调整集群大小.md">调整集群大小</a>：优化扩容集群的前提条件。</li><li><a href="重启集群.md">重启集群</a>：优化重启集群对系统的影响。</li><li><a href="创建集群.md">创建集群</a>：新增为集群创建默认安全组的相关内容。</li><li><a href="设置数据库审计日志.md">设置数据库审计日志</a>：新增审计日志保留策略。</li><li><a href="下载客户端.md">下载客户端</a>：增加第三方开源PostgreSQL客户端。</li></ul>
...
<a name="ul65381936161834"></a><a name="ul65381936161834"></a><ul id="ul65381936161834"><li>增加以下内容：<a name="ul36777350211848"></a><a name="ul36777350211848"></a><ul id="ul36777350211848"><li><a href="管理创建失败的集群.md">管理创建失败的集群</a></li><li><a href="重置密码.md">重置密码</a></li><li><a href="使用JDBC连接数据库.md">使用JDBC连接数据库</a></li><li>SQL简介</li><li><a href="更新MRS数据源配置.md">更新MRS数据源配置</a></li><li><a href="错误码参考.md">错误码参考</a></li></ul>
</li><li>修改以下内容：<a name="ul16797980211848"></a><a name="ul16797980211848"></a><ul id="ul16797980211848"><li><a href="登录DWS管理控制台.md">管理集群</a></li><li><a href="手动创建快照.md">手动创建快照</a></li><li><a href="恢复快照.md">恢复快照</a></li><li><a href="使用gsql客户端连接集群.md">使用gsql客户端连接集群</a></li><li>从OBS导入数据到集群</li><li>导入数据</li><li>从集群导出数据到OBS</li><li>导出数据</li></ul>
</li></ul>
</td>
</tr>
...
<a name="ul390919918562"></a><a name="ul390919918562"></a><ul id="ul390919918562"><li>增加以下章节：<a name="ul6620049585938"></a><a name="ul6620049585938"></a><ul id="ul6620049585938"><li><a href="调整集群大小.md">调整集群大小</a></li><li><a href="设置三权分立.md">设置三权分立</a></li><li><a href="（可选）设置SSL连接.md">（可选）设置SSL连接</a></li><li>管理数据库审计</li><li><a href="从MRS导入数据概述.md">从MRS导入数据概述</a></li><li><a href="创建MRS数据源连接.md">创建MRS数据源连接</a></li><li><a href="更新MRS数据源配置.md">更新MRS数据源配置</a></li></ul>
