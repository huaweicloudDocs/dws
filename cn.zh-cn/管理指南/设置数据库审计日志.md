...
关于如何查看审计日志信息，请参见《数据仓库服务数据库开发指南》中[查看审计信息](http://support.huaweicloud.com/devg-dws/query_audit_Info_0001.html)章节。
...
6.  单击“应用“。
    ...
    单击![](figures/icon_dws_refresh_blue.jpg)，“配置状态“显示为“应用中“，表示系统正在保存配置。
