...
4.  选择“节点规格“。
    ...
    **表 2**  主机规格参数说明
    ...
    <tbody><tr id="row13264135515209"><td class="cellrowborder" valign="top" width="20.41%" headers="mcps1.2.4.1.1 "><p id="p02651655182013"><a name="p02651655182013"></a><a name="p02651655182013"></a>集群类型</p>
    </td>
    <td class="cellrowborder" valign="top" width="60.4%" headers="mcps1.2.4.1.2 "><p id="p19265145582018"><a name="p19265145582018"></a><a name="p19265145582018"></a>集群类型有：</p>
    ...
    <td class="cellrowborder" valign="top" width="19.189999999999998%" headers="mcps1.2.4.1.3 "><p id="p1226585512016"><a name="p1226585512016"></a><a name="p1226585512016"></a>计算密集型</p>
    </td>
    </tr>
    <tr id="row361421141419"><td class="cellrowborder" valign="top" width="20.41%" headers="mcps1.2.4.1.1 "><p id="p4467319276"><a name="p4467319276"></a><a name="p4467319276"></a>节点规格</p>
    </td>
    <td class="cellrowborder" valign="top" width="60.4%" headers="mcps1.2.4.1.2 "><p id="p4126175441619"><a name="p4126175441619"></a><a name="p4126175441619"></a>请根据业务需求合理选择节点类型。在节点类型列表中展示了每一种节点类型单个节点的vCPU、内存、存储、I/O、并发队列数和建议使用场景。其中，“并发队列数”是系统支持最大限度的并发作业数，与规格强相关。</p>
    ...
    <td class="cellrowborder" valign="top" width="19.189999999999998%" headers="mcps1.2.4.1.3 "><p id="p9177203124512"><a name="p9177203124512"></a><a name="p9177203124512"></a>dws.dc.4xlarge</p>
    </td>
    </tr>
...
5.  填写“集群配置“参数。
    ...
    **表 3**  集群配置参数说明
    ...
    <a name="ul1838791391412"></a><a name="ul1838791391412"></a><ul id="ul1838791391412"><li>只能由小写字母、数字或下划线组成。</li><li>必须以小写字母或下划线开头。</li><li>长度为6～64个字符。</li><li>用户名不能为DWS数据库的关键字。DWS数据库的关键字，具体请参见《数据仓库服务数据库开发指南》中<a href="https://support.huaweicloud.com/devg-dws/keyword.html" target="_blank" rel="noopener noreferrer">关键字</a>章节。</li></ul>
    </td>
