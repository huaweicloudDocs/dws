...
4.  选择“主机规格“。
    ...
    **表 3**  规格说明
    ...
    <tr id="row184671646104312"><td class="cellrowborder" valign="top" width="29.23%" headers="mcps1.2.6.1.1 "><p id="p212417398205"><a name="p212417398205"></a><a name="p212417398205"></a>dws.ds.4xlarge</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.65%" headers="mcps1.2.6.1.2 "><p id="p712403972020"><a name="p712403972020"></a><a name="p712403972020"></a>6</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.31%" headers="mcps1.2.6.1.3 "><p id="p1412453982012"><a name="p1412453982012"></a><a name="p1412453982012"></a>128</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.37%" headers="mcps1.2.6.1.4 "><p id="p4468134612437"><a name="p4468134612437"></a><a name="p4468134612437"></a>5.03 TB</p>
    </td>
    <td class="cellrowborder" valign="top" width="28.439999999999998%" headers="mcps1.2.6.1.5 "><p id="p154681946124314"><a name="p154681946124314"></a><a name="p154681946124314"></a>存储密集型，本地盘（SAS）</p>
    </td>
    </tr>
    <tr id="row8349143514313"><td class="cellrowborder" valign="top" width="29.23%" headers="mcps1.2.6.1.1 "><p id="p6449115142010"><a name="p6449115142010"></a><a name="p6449115142010"></a>dws.ds.8xlarge</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.65%" headers="mcps1.2.6.1.2 "><p id="p1244919514209"><a name="p1244919514209"></a><a name="p1244919514209"></a>32</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.31%" headers="mcps1.2.6.1.3 "><p id="p1444918519202"><a name="p1444918519202"></a><a name="p1444918519202"></a>256</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.37%" headers="mcps1.2.6.1.4 "><p id="p1935073513435"><a name="p1935073513435"></a><a name="p1935073513435"></a>10.05 TB</p>
    </td>
    <td class="cellrowborder" valign="top" width="28.439999999999998%" headers="mcps1.2.6.1.5 "><p id="p1035073584319"><a name="p1035073584319"></a><a name="p1035073584319"></a>存储密集型，本地盘（SAS）</p>
    </td>
    </tr>
    ...
    <tr id="row125323411447"><td class="cellrowborder" valign="top" width="29.23%" headers="mcps1.2.6.1.1 "><p id="p6982165122416"><a name="p6982165122416"></a><a name="p6982165122416"></a>dws.dc.15xlarge</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.65%" headers="mcps1.2.6.1.2 "><p id="p12982185119246"><a name="p12982185119246"></a><a name="p12982185119246"></a>60</p>
    </td>
    <td class="cellrowborder" valign="top" width="12.31%" headers="mcps1.2.6.1.3 "><p id="p1298219518242"><a name="p1298219518242"></a><a name="p1298219518242"></a>512</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.37%" headers="mcps1.2.6.1.4 "><p id="p653315415445"><a name="p653315415445"></a><a name="p653315415445"></a>5.22 TB</p>
    </td>
    <td class="cellrowborder" valign="top" width="28.439999999999998%" headers="mcps1.2.6.1.5 "><p id="p653319404415"><a name="p653319404415"></a><a name="p653319404415"></a>计算密集型，本地盘（SSD）</p>
    </td>
    </tr>
...
8.  高级配置，可选择如下选项：
    ...
    -   **自定义**：选择该选项时，请自定义设置以下几项高级配置。
        ...
        -   **加密数据库**
            ...
            ![](figures/icon_dws_on.png)表示启用数据库加密。每个区域的每个项目首次启用数据库加密时，系统会弹出一个“创建委托”的对话框，单击“是“创建委托以授权DWS访问KMS并创建一个KMS专业版密钥用来加解密DWS数据库，若单击“否“将不会启用加密功能。然后在“密钥名称“的下拉列表中选择已创建的KMS专业版密钥。如果没有专业版密钥，可以登录KMS服务进行创建，详细操作请参见[《数据加密服务用户指南》](https://support.huaweicloud.com/dew/index.html)。
