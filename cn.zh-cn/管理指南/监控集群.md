...
6.  在“创建告警规则”界面，根据界面提示配置参数。
    ...
    2.  配置告警内容，根据界面提示配置参数。
        ...
        **表 3**  配置告警内容
        ...
        <td class="cellrowborder" valign="top" width="50.305030503050304%" headers="mcps1.2.4.1.2 "><p id="p1073262955416"><a name="p1073262955416"></a><a name="p1073262955416"></a>告警规则适用的资源范围，选择<span class="parmvalue" id="parmvalue18732142975412"><a name="parmvalue18732142975412"></a><a name="parmvalue18732142975412"></a>“指定资源”</span>，然后勾选具体的监控对象，可以是一个或多个。对于DWS而言，选择您创建的集群实例ID或节点ID。单击<a name="image2730104065218"></a><a name="image2730104065218"></a><span><img id="image2730104065218" src="figures/zh-cn_image_0166118677.png"></span>将监控对象同步到右侧对话框。</p>
        </td>
