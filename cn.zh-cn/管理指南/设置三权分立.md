...
4.  在“安全设置“页面，填写“安全配置“。
    ...
    **表 1**  安全配置参数说明
    ...
    <td class="cellrowborder" valign="top" width="59%" headers="mcps1.2.4.1.2 "><p id="p19353101144415"><a name="p19353101144415"></a><a name="p19353101144415"></a><a name="image441614208516"></a><a name="image441614208516"></a><span><img id="image441614208516" src="figures/icon_dws_on.png"></span>表示开启三权分立模式。</p>
