# 查看集群状态<a name="ZH-CN_TOPIC_0000001098976690"></a>
...
<td class="cellrowborder" valign="top" width="83.93%" headers="mcps1.2.3.1.2 "><p id="p7998233192818"><a name="p7998233192818"></a><a name="p7998233192818"></a>如果集群中存在gtm或dn的角色和初始角色不一致，就认为处于非均衡状态。 非均衡状态下会出现某些节点主实例增多，从而负载压力较大。这种情况下集群状态是正常的，但整体性能要不如均衡状态。建议业务低峰期，切换为均衡状态。</p>
</td>
</tr>
