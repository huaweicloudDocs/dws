...
-   参数说明
    ...
    **表 2**  请求参数说明
    ...
    <td class="cellrowborder" valign="top" width="59.63%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0084768514_p49022807"><a name="zh-cn_topic_0084768514_p49022807"></a><a name="zh-cn_topic_0084768514_p49022807"></a>指定集群服务端口（8000~10000），默认值：8000。</p>
    </td>
    </tr>
